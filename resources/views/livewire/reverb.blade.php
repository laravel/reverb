...
<x-pulse::card :cols="$cols" :rows="$rows" :class="$class">
    <x-pulse::card-header
        name="Reverb"
        title="Average Connections Time: {{ number_format($averageConnectionsTime) }}ms; Run at: {{ $averageConnectionsRunAt }};"
                ...
                {{-- <div wire:key="messages">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex flex-wrap gap-4">
                            <div class="flex items-center gap-2 text-xs text-gray-600 dark:text-gray-400 font-medium">
                                <div class="h-0.5 w-3 rounded-full bg-[rgba(147,51,234,0.5)]"></div>
                                Message per {{ $messageRateUnit }}
                            </div>
                        </div>
                    </div>

                    @php
                        $highest = $messageRates->flatten()->max();
                    @endphp
                    ...
                    <div class="mt-3 relative">
                        ...
                        <div
                            wire:ignore
                            class="h-14"
                            x-data="messageRatesChart({
                                type: 'Messages',
                                readings: @js($messageRates),
                                sampleRate: {{ $config['sample_rate'] }},
                            })"
                        >
                            <canvas x-ref="messageRatesCanvas" class="ring-1 ring-gray-900/5 dark:ring-gray-100/10 bg-gray-50 dark:bg-gray-800 rounded-md shadow-sm"></canvas>
                        </div>
                    </div>
                </div> --}}
            </div>
